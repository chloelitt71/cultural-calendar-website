...
const CULTURAL_SEASONAL_RAW: Raw[] = [
  {
    id: 'spring-beauty',
    title: 'Spring skincare & reset moment',
    date: 'Apr 13–May 31, 2026',
    startDate: '2026-04-13',
    endDate: '2026-05-31',
    location: 'Global',
    category: 'Cultural Moments',
    subcategory: 'Seasonal beauty velocity',
    source: 'Curated',
    region: 'Global',
    industries: ['Beauty', 'Wellness', 'Lifestyle'],
  },
  {
    id: 'internet-micro-trends',
    title: 'Internet micro-trend cycles',
    date: 'Rolling · 2026',
    startDate: '2026-04-19',
    endDate: '2026-12-31',
    location: 'Global',
    category: 'Cultural Moments',
    subcategory: 'TikTok / IG velocity',
    source: 'Curated',
    region: 'Global',
  ...
  {
    id: 'holiday-film',
    title: 'Holiday blockbuster trailer & gifting corridor',
    date: 'Nov 1–Dec 31, 2026',
    startDate: '2026-11-01',
    endDate: '2026-12-31',
    location: 'Global',
    category: 'Cultural Moments',
    subcategory: 'Entertainment commerce',
    source: 'Curated',
    region: 'Global',
    industries: ['Entertainment', 'Food & Beverage', 'Lifestyle'],
  },
